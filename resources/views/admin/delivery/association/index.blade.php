        ...
        <div class="col-xl-12">
            <div class="card m-b-20">
                <div class="card-header">
                    <div class="col-md-2">
                        <div class="card-title">{{ trans('french.Associated Rules')}}</div>
                    </div>
                    <div class="col-md-10">
                        ...
                        <table id="example" class="table table-striped table-bordered" width=100%>
                            <thead>
                                <tr>
                                    ...
                                    <td style="font-weight: bold">{{ trans('french.Customer Name')}}</td>
                                    <td style="font-weight: bold">{{ trans('french.Supplier Name')}}</td>
                                    <td style="font-weight: bold">{{ trans('french.Rule Name')}} </td>
                                ...
                                @else
                                    @foreach ($associate as $associate_item)
                                        <tr>
                                            ...
                                            <td>{{ substr(App\Models\Rule::find($associate_item->rule_id)->name,0,20) }}</td>
                                            <td>

                                                    ...
                                                    <div class="modal-content">
                                                            ...
                                                            <div id="data" style="display: none">
                                                                <div style="padding: 10px">
                                                                    ...
                                                                    <div
                                                                                    ...
                                                                                    <textarea name="comments" class="form-control" maxlength="100" id="comments" cols="30" rows="3" required></textarea>
                                                                                </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="modal-footer" id="modal_footer" style="display: none">
                                                            <a href="#"><button type="button" class="btn btn-success"
                                                                    data-dismiss="modal" id="modal_success">Confirm Date</button></a>
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-footer" id="modal_footer"
                                                                        ...
                                                                        <a href="#"><button type="button"
                                                                                ...
                                                                                data-dismiss="modal"
                                                                                id="modal_success">Confirm Date</button></a>
        ...
        $(document).on('show.bs.modal', '.modal', function(e) {
            ...
            setTimeout(() => {
                ...
                if (next_delivery_date.length > 0) {
                    ...
                    $('label.selectgroup-item input').on('change', function() {
                            ...
                            success: function(response) {
                                ...
                                if (response.redirect == true) {
                                    if(response[0].message){
                                        ...
                                        '/order/confirmed/' + response[0].data + '/'+ response[0].message+'/'+ response[0].date;
                                    }else{
                                        window.location.href = baseUrl +

        ...
        <div class="table-responsive">
            <table class="table table-bordered border-top mb-0" style="background:white;" id="my-table">
                ...
                <tbody id='table-body'>
                    ...
                    @php
                    $cart =
                    bilawalsh\cart\Models\Cart::with('products')->where(['supplier_id'=>$id,'user_id'=>Auth::id()])->first();
                    @endphp
                    @foreach($products as $product)
                    @php
                    $data =
                    bilawalsh\cart\Models\CartItem::where(['product_id'=>$product->id,'cart_id'=>$cart->id])->first();
                    @endphp
                    <tr>

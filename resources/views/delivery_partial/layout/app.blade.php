...
<head>
    ...
    <link href="{{ asset('admin/assets/plugins/fullcalendar/fullcalendar.print.min.css') }}" rel='stylesheet'
        media='print' />
    ...
    @include('delivery_partial.partials.basic.head')
    @yield('css')
</head>
...
<body class="app sidebar-mini">
    ...
    <div class="page">
        <div class="page-main">
            <!--App-Header-->
            @include('delivery_partial.partials.basic.nav')
            <!--/App-Header-->
            <!-- Sidebar menu-->
            @include('delivery_partial.partials.sidebar')
            <!-- /Sidebar menu-->
            <!--App-Content-->
            <div class="app-content">
                <div class="side-app">
                    ...
                    @yield('content')
                    <!--Footer-->
                    @include('delivery_partial.partials.footer')
                    <!--/Footer-->
                </div>
            </div>
        </div>
    ...
    @include('delivery_partial.partials.basic.script')

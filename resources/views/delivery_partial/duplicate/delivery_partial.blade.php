            ...
            <div class="card m-b-20">
                ...
                <div class="card-body">
                    <form action="" method="POST" id="formData">
                        ...
                        <button type="submit" class="btn btn-primary">Is Working Day</button>
                        <button type="submit" class="btn btn-primary">Is Delivery Day</button>
                        <button type="submit" class="btn btn-primary">Delivery Date</button>
                    </form>
                </div>
            </div>
        </div>
